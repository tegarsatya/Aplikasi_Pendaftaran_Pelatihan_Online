                ...
                <nav class="navbar">
                    ...
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            ...
                            <li class="dropdown">
                                ...
                                <ul class="dropdown-menu sub-menu">
                                    <?php foreach ($nav_fasilitas as $nav_fasilitas) { ?>
                                        <li class="sub-active"><a href="<?php echo base_url('berita/fasilitas/' . $nav_fasilitas->slug_berita) ?>"><i class="fa fa-angle-double-right" aria-hidden="true"></i> <?php echo $nav_fasilitas->judul_berita ?></a></li>
                                    <?php } ?>
                                </ul>
                            </li>
                            <!-- End Fasilitas -->
                            ...
                            <li class="dropdown">
                                <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="false">DAFTAR Akun<span class="caret"></span></a>
                                <ul class="dropdown-menu sub-menu">

                                    <li class="sub-active"><a href="<?php echo base_url('login_member'); ?>"><i class="fa fa-unlock-alt" aria-hidden="true"> </i> Login </a></li>
                                    <li class="sub-active"><a href="<?php echo base_url('register'); ?>"><i class="fa fa-users" aria-hidden="true"> </i> Register </a></li>
                                </ul>
                            </li>
