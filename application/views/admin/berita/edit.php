...
<div class="row">
  <div class="col-md-8">
    ...
    <div class="form-group form-group-lg">
      <label>Judul berita/profil/layanan/fasilitas</label>
  ...
  <div class="col-md-4">
    ...
    <div class="form-group form-group-lg">
      <label>Icon berita/profil/layanan/fasilitas</label>
  ...
  <div class="col-md-3">
    ...
    <div class="form-group">
      ...
      <select name="jenis_berita" class="form-control">
        ...
        <option value="Fasilitas" <?php if ($berita->jenis_berita == "Fasilitas") {
                                    echo "selected";
                                  } ?>>Fasilitas</option>
      </select>
